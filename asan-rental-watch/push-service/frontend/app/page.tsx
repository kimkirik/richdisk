...
async function requestNotices(): Promise<NoticeResponse> {
  const url = new URL("api/notices", document.baseURI);
      ...
      <section className="signal-strip" id="top">
        <div className="signal-inner">
          ...
          <p>
            ...
            <span> · {monitoringReady ? "공식 출처 30분 간격 확인" : "자동 공고 감시 연결 대기"} · 신청 전 원문 확인</span>
          </p>
          ...
          <div className="detail-inner">
            ...
            <section className={"notification-hub " + notificationState} aria-label="새 공고 알림 설정">
              ...
              <div>
                ...
                <p>
                  {monitoringReady ? "공식 사이트를 약 30분마다 확인하고, 새 공고를 발견하면 앱 알림을 보냅니다." : "자동 공고 감시 서버 연결 전입니다. 현재는 공고 열람과 기기 시험 알림을 이용할 수 있습니다."}
                </p>
              </div>
      ...
      <Dialog open={notificationOpen} onOpenChange={setNotificationOpen}>
        <DialogContent className="notification-dialog">
          <DialogHeader>
            ...
            <DialogDescription>
              {!monitoringReady ? "기기 알림 연결과 시험 수신을 설정할 수 있습니다. 새 공고 자동 감시는 서버 연결 대기 중입니다." : platform.isIOS ? "iOS 16.4 이상 · 홈 화면에 설치하면 앱을 닫아도 알림을 받습니다." : "안드로이드 기본 · 회원가입 없이 앱을 닫아도 공고 알림을 받습니다."}
            </DialogDescription>
          </DialogHeader>
          ...
          {!monitoringReady && <p className="install-message" role="alert">자동 공고 감시 서버 연결 대기 중입니다. 시험 알림 수신과 별개로, 새 공고 자동 알림은 아직 가동 중이 아닙니다.</p>}
          ...
          <div className="background-caveat">
            <Info size={16} />
            <p>
              {monitoringReady ? "공고 확인은 약 30분 간격이며 점검 지연이 생길 수 있습니다. " : "자동 감시 연결이 완료될 때까지 공식 공고를 직접 확인해 주세요. "}휴대폰이 꺼져 있거나 인터넷·알림 권한·배터리 제한으로 알림이 늦어질 수 있으니 시험 알림을 꼭 확인하세요. 구독 정보와 발송·표시 확인 기록을 저장하며, ‘이 기기 알림 끄기’로 구독을 삭제할 수 있습니다.
            </p>
          </div>
        </DialogContent>
      </Dialog>
