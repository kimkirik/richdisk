...
Portrait phones display the entire battlefield with a 90-degree camera turn. Roads and placement points keep their geometry; buildings, units and labels remain upright. At 390×844 the map occupies about three quarters of the viewport area, with 12–19px primary labels and compact icons. All landscape viewports use the full screen for the battlefield, including tablets taller than 540px. The defense picker opens from the floating 방어기 button and closes after choosing a tower. Wave, upgrade, speed, pause and skill controls remain available over the map. Landscape towers use a smaller 1.0 visual scale (previously 1.3 on phones); regular enemies and bosses retain their enlarged visuals and readable health HUD. Announcements no longer cover the middle of combat.
