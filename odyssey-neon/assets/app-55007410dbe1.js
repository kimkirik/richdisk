...
function E() {
  ...
  let xe = (0, f.useCallback)((e, t, n = S.pink, r = 18) => {
    ...
    Te = (0, f.useCallback)(() => {
      ...
      he.current !== `playing` ||
        ...
        e.foes.forEach((e) => {
          ((e.hp -= 70), xe(e.x, e.y, S.gold, 8), e.hp <= 0 && we(e));
        }),
    ...
    Ee = () => {
      ...
      e.foes.push({
        ...
        vy: 2.1 + Math.min(4.8, e.level * 0.014),
        hp: n,
        max: n,
        r: t ? 28 : 17,
        boss: !1,
      ...
      let i = r.getContext(`2d`),
        o = (timestamp = 0) => {
          ...
          while (steps-- > 0 && he.current === "playing") {
            ...
            let t = n.current.has(`ShiftLeft`) ? 4 : 7;
            ((n.current.has(`ArrowLeft`) || n.current.has(`KeyA`)) &&
              ...
              (r.x = Math.max(
                34 + (r.double > 0 ? 36 : 0),
                Math.min(766 - (r.double > 0 ? 36 : 0), r.x),
              )),
              (r.y = Math.max(50, Math.min(775, r.y))),
              (n.current.has(`Space`) || a.current) && Ce(),
              e.foes.length < b &&
              ...
              e.foes.forEach((t) => {
                if (
                  ((t.phase += t.final ? 0.055 : t.elite ? 0.05 : 0.035),
                  (t.y += t.vy),
                  (t.x +=
                    t.vx +
                    Math.sin(t.phase) *
                      (t.final ? 5 : t.boss ? 3 : t.elite ? 2.8 : 1.5)),
                  t.boss && t.y > (t.final ? 125 : 100) && (t.vy = 0),
                  t.boss &&
                    e.tick %
                      Math.max(
                        t.final ? 16 : 24,
                        70 - Math.floor(e.level / 7),
                      ) ===
                      0)
                ) {
                  let n = t.final ? 5 : 3;
                  for (let r = -n; r <= n; r++)
                    e.shots.push({
                      x: t.x,
                      y: t.y + t.r * 0.72,
                      vx: r * (t.final ? 1.25 : 1.6),
                      vy:
                        4.6 + Math.min(3, e.level * 0.008) + Math.abs(r) * 0.18,
                      enemy: !0,
                      kind: `missile`,
                    });
                } else if (
                  t.elite &&
                  e.tick % Math.max(38, 88 - Math.floor(e.level / 8)) === 0
                ) {
                  let n = r.x - t.x,
                    i = r.y - t.y,
                    a = Math.max(1, Math.hypot(n, i)),
                    o = 5.2 + Math.min(2.2, e.level * 0.007);
                  for (let r of [-0.24, 0, 0.24]) {
                    let s = n / a,
                      c = i / a;
                    e.shots.push({
                      x: t.x,
                      y: t.y + 20,
                      vx: (s * Math.cos(r) - c * Math.sin(r)) * o,
                      vy: (s * Math.sin(r) + c * Math.cos(r)) * o,
                      enemy: !0,
                      kind: `missile`,
                    });
                  }
                  ...
                  !t.boss &&
                    e.tick % Math.max(45, 130 - Math.floor(e.level / 3)) ===
                      0 &&
                    e.shots.push({
                      x: t.x,
                      y: t.y,
                      vx: 0,
                      vy: 4.5 + Math.min(3.5, e.level * 0.009),
                      enemy: !0,
                      kind: `plasma`,
                    });
              }),
            ...
            for (const shot of s) {
              if (
                !shot.dead &&
                r.inv <= 0 &&
                Math.hypot(shot.x - r.x, shot.y - r.y) < 14
              ) {
                shot.dead = true;
                Oe();
              }
            ...
            for (const foe of e.foes) {
              if (
                r.inv <= 0 &&
                Math.hypot(foe.x - r.x, foe.y - r.y) < foe.r + 11
              ) {
                Oe();
            ...
            e.foes.forEach((e) => {
              ...
              (t.addColorStop(
                ...
                e.boss &&
                  ...
                  (i.textAlign = `center`),
                  i.fillText(
                    e.final ? `FINAL BOSS · ODYSSEY CORE` : `SECTOR BOSS`,
                    400,
                    70,
                  )));
            }),
  ...
  let ke = (e) => {
      ...
      ((u.current.ship.x = ((e.clientX - t.left) * m) / t.width),
        (u.current.ship.y = Math.min(
          775,
          ((e.clientY - t.top) * h) / t.height,
        )));
    },
            ...
            children: [
              (0, p.jsxs)(`div`, {
                children: [
                  (0, p.jsx)(`span`, {
                    className: `eyebrow`,
                    children: `NEON ARCADE · WING LINK`,
                  }),
                  (0, p.jsxs)(`h1`, {
                    children: [
                      `오딧세이 `,
                ...
                (0, p.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, p.jsx)("div", {
                      ...
                      children:
                        "D를 모아 2·3기 합체 · 무기 4종 · 12연속 격추 오버드라이브",
                    }),
                    (0, p.jsxs)(`label`, {
                  ...
                  children: [
                    (0, p.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, p.jsx)(`span`, {
                          children: `Space · 모바일 자동 사격`,
                        }),
                        (0, p.jsx)(`b`, { children: `필살기` }),
                        (0, p.jsx)(`span`, { children: `B · 하단 폭탄 버튼` }),
                      ...
                      children: [
                        ...
                        (0, p.jsxs)(`p`, {
                          children: [
                            ...
                            (0, p.jsx)(`em`, {
                              children: `D 1개 = 2기 · D 2개 = 3기 합체 · 추가 D는 실드와 점수`,
                            }),
                          ],
                        }),
                        (0, p.jsxs)(`p`, {
          ...
          (0, p.jsxs)(`div`, {
            ...
            children: [
              (0, p.jsxs)("div", {
                ...
                children: [
                  (0, p.jsx)("b", {
                    children: `${E.double + 1}기 ${E.double ? "합체" : "출격"}`,
                  }),
                  (0, p.jsx)("span", {
                    children: weaponSpec(E.weapon).description,
                  }),
                ],
              }),
              (0, p.jsxs)(`div`, {
...
function ie({ label: e, value: t, color: n }) {
  return (0, p.jsxs)(`div`, {
    className: `meter`,
    children: [
