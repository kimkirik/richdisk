...
export function getTideAdjustment(mulLabel: string): number | null {
  ...
  if (/^(?:[1-9]|1[0-3])물$/.test(mulLabel) || mulLabel === "조금" || mulLabel === "무시") return -15;
  return null;
}
...
export const SCORE_POLICY_DESCRIPTION = "기본 60점 + 날씨 최대 25점. 4·5·6물만 +15점, 나머지 물때는 −15점. 물색은 약간 흐림 −10점, 많이 흐림 −20점, 커피물 가능성 큼 −30점. 최종 점수는 0~100점입니다.";
